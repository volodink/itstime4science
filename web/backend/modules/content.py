	...
	main = {"title": "itstime4science | Главная",
			...
			"team_photo": {"team_row_title": "Сотрудники лаборатории ВВиВС",
							"people": (volodink,
										...
										volkova)},
			"description": """ 
				<p>Лаборатория “Высокопроизводительные вычисления и встраиваемые системы” (<b>ВВиВС</b>) была основана в 2015 году.</p> 
                ...
                <p>В нашей лаборатории студенты развивают навыки 3D моделирования в САПР Компас 3D с последующей печатью деталей на 3D принтере.</p>
	...
	copter = {"title": "itstime4science | Коптер",
			...
			"description": """
				...
				<p>
				   ...
				   МГУ имени М.В. Ломоносова (НИИЯФ МГУ) с проектом “Коптер”.
				</p>
				
				<p>
				   Перед ними стоит задача - <i>разработать автоматизированный комплекс мониторинга очагов пожара.</i>
				</p>
				...
				<p>
				   ...
				   <ul>
					   ...
					   <li>определить очаг пожара, используя технологии компьютерного зрения и машинного обучения, 
					       с применением современных библиотек, таких как OpenCV;</li>
					   <li>отправить координаты очага пожара на наземную станцию;</li>
					   <li>сбросить на очаг пожара 'метку' (мячик для пинг-понга).</li>
                                   </ul>
				</p>
			"""
			}
	...
	satellite = {"title": "itstime4science | Студенческая лига",
				...
				"description": """
					...
					<p>
					   ...
					   с использованием аппарата форм-фактора  <a href="https://ru.wikipedia.org/wiki/CubeSat">CubeSat</a>.
					</p>
...
panel_tags = [
	...
	('Дата и время', 'datetime','Год-месяц-день час:минута:секунда', 'srtc'),
	...
	('Температура №1', 'temp1', 'Данные с первого датчика температуры, °С','stermometr1'),
	('Температура №2', 'temp2', 'Данные с  второго датчика температуры, °С','stermometr2'),
	('Давление №1', 'pressure1', 'Давление с первого датчика ,Паскаль','sbarometr1'),
	('Давление №2', 'pressure2', 'Давление с второго датчика, Паскаль','sbarometr2'),
	('Аксель. по x', 'vect_axel1x', 'м/с^2','svect_axel1'),
	('Аксель. по  y', 'vect_axel1y', 'м/с^2',''),
	('Аксель. по  z', 'vect_axel1z', 'м/с^2',''),
	('Ультрафиолет №1', 'ultraviolet1','Данные с первого датчика ультрафиолетового излучения, Люкс','sultraviolet1'),
	('Ультрафиолет №2', 'ultraviolet2','Данные с второго датчика ультрафиолетового излучения, Люкс','sultraviolet2'),
	('Инфр.излуч. №1', 'infrared1','Данные с первого датчика инфракрасного излучения, Люкс','sinfrared1'),
	('Инфр.излуч. №2', 'infrared2','Данные с второго датчика инфракрасного излучения, Люкс','sinfrared2'),
	('HDOP', 'hdop','Cнижение точности в горизонтальной плоскости','shdop'),
	('VDOP', 'vdop','Снижение точности в вертикальной плоскости','svdop'),
	('Количество спутников', 'sats','Количество спутников, улавливаемые аппаратом','ssats'),
	('Радиация', 'radiation','Ренген/час','sradiation'),
	('Датчик пыли', 'dust','Мг/м^3','sdust'),
	('Датчик озона', 'ozone','PPM(англ.), Миллионная доля','sozone'),
