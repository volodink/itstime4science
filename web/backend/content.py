...
panel_tags = [
	...
	('Широта,°', 'lat',''),
	('Долгота,°', 'lon',''),
	('Высота, метры', 'alt', 'Метры'),
	('Заряд аккумулятора, %', 'bat_crg',''),
	('Напряжение аккумуляторара, ', 'bat_volt', 'Вольт'),
	('Температура аккумулятора', 'bat_temp', '°С'),
	('Датчик температуры №1', 'temp1', '°С'),
	('Датчик температуры №2', 'temp2', '°С'),
	('Датчик давления №1', 'pressure1', 'Паскаль'),
	('Датчик давления №2', 'pressure2', 'Паскаль'),
	('Вектор аксе-ра 1 по x', 'vect_axel1x', 'м/с^2'),
	('Вектор аксе-ра 1 по y', 'vect_axel1y', 'м/с^2'),
	('Вектор аксе-ра 1 по z', 'vect_axel1z', 'м/с^2'),
	('Вектор аксе-ра 2 по x', 'vect_axel2x', 'м/с^2'),
	('Вектор аксе-ра 2 по y', 'vect_axel2y', 'м/с^2'),
	('Вектор аксе-ра 2 по z', 'vect_axel2z', 'м/с^2'),
	('Датчик ультрафиолета №1', 'ultraviolet1','Люкс'),
	('датчик ультрафиолета №2', 'ultraviolet2','Люкс'),
	('Датчик инфракрасного излуч. №1', 'infrared1','Люкс'),
	('Датчик инфракрасного излуч. №2', 'infrared2','Люкс'),
	('HDOP', 'hdop','Cнижение точности в горизонтальной плоскости'),
	('VDOP', 'vdop','Снижение точности в вертикальной плоскости'),
	('Количество спутников', 'sats',''),
	('Радиация', 'radiation','Ренген'),
	('Датчик пыли', 'dust','мг/м^3'),
	('Датчик озона', 'ozone','')
]
